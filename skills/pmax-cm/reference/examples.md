...
Stop detection fires after E4. Skill asks "Ready to build?" User says yes. Total: 4 questions across 2 rounds.
...
Phase 0 loaded `templates/skill-from-ground-up.md`. The `[discovered]` label on E2 signals the template came from file reading, not user input.
