...
GROQ_CAPTURE_MAX_TOKENS: int = 4096
CAPTURE_INTER_REQUEST_THROTTLE_SECONDS: float = 2.5
CAPTURE_MAX_RETRIES_PER_JOB: int = 3
CAPTURE_RETRY_BACKOFF_BASE_SECONDS: float = 5.0
CAPTURE_RETRY_BACKOFF_EXPONENT_BASE: int = 2
